defmodule LightAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LightAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LightAppWeb.Gettext, "errors", msg, opts)
    end
  end
